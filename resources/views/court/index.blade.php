...
@section('action-button')
    @can('create court')
        <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
            <a href="javascript:void(0)" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="md" data-title="Add Courts/Tribunal"
                        ...
                        <table class="table dataTable data-table">
                            ...
                            <tbody>
                                ...
                                @foreach ($courts as $court)
                                    <tr>
                                        <td><a href="javascript:void(0)" class="mx-3 btn btn-sm d-inline-flex align-items-center " data-url="{{ route('courts.edit',$court->id) }}"
