...
<div class="text-sm-end d-flex all-button-box justify-content-sm-end">
    <a href="javascript:void(0)" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="lg" data-title="Add Role"
                                ...
                                <td class="" style="white-space: inherit">
                                    ...
                                    @foreach ($role->permissions as $permission)
                                        <span class="badge rounded p-2 m-1 px-3 bg-primary">
                                            <a href="javascript:void(0)" class="text-white">{{ $permission->name }}</a>
                                        </span>
                                    @endforeach
                                </td>
                                <td>
