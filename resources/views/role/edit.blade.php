        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    @error('name')
                    <span class="text-xs invalid-name text-danger" role="alert">{{ $message }}</span>
                    @enderror
                </div>
            </div>
        </div>
                        ...
                        <div class="table-border-style">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    @php
                                        $modules=['dashboard','client','advocate','document','doctype','member','group','court','highcourt','bench','cause','case','todo','bill','tax','diary','timesheet','expense','feereceived','calendar','motions','setting','libraries'];
