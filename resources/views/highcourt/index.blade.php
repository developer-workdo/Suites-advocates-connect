...
@section('action-button')
    @can('create highcourt')
        <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
            <a href="javascript:void(0)" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="md" data-title="Add High Court"
                        ...
                        <table class="table dataTable data-table">
                            ...
                            <tbody>
                                ...
                                @foreach ($hicrts as $court)
                                    <tr>
                                        <td><a href="javascript:void(0)" class="btn btn-sm" data-url="{{ route('highcourts.edit',$court->id) }}" data-size="md"
