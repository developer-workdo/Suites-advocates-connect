                ...
                <li class="dropdown dash-h-item drp-company">
                    ...
                    <div class="dropdown-menu dash-h-dropdown">
                        ...
                        <form method="POST" action="{{ route('logout') }}" id="form_logout">
                            @csrf
                            <a href="javascript:void(0)"  class="dropdown-item" id="logout-form">
                ...
                <li class="dropdown dash-h-item drp-language">
                    ...
                    <div class="dropdown-menu dash-h-dropdown dropdown-menu-end " aria-labelledby="dropdownLanguage">
                        ...
                        @can('create language')
                            ...
                            <a href="javascript:void(0)" data-url="{{ route('create.language') }}" data-size="md" data-ajax-popup="true" data-title="{{__('Create New Language')}}"
