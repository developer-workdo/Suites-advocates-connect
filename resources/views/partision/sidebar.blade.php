@php
    ...
    $modeSetting = \App\Models\Utility::mode_layout();
    $logo = asset('storage/uploads/logo/');
    $companyLogo = Utility::get_company_logo();
    $premission = [];
    $premissionArr = [];
    if (\Auth::user()->super_admin_employee == 1) {
        $premission = json_decode(\Auth::user()->permission_json);
        $premissionArr = get_object_vars($premission);
    }
@endphp
...
<nav
    class="dash-sidebar light-sidebar {{ isset($modeSetting['cust_theme_bg']) && $modeSetting['cust_theme_bg'] == 'on' ? 'transprent-bg' : '' }}">

    <div class="navbar-wrapper">
        <div class="m-header main-logo">
            <a href="{{ route('dashboard') }}" class="b-brand">
                <!-- ========   change your logo hear   ============ -->
                <img src="{{ $logo . '/' . (isset($companyLogo) && !empty($companyLogo) ? $companyLogo : 'logo-dark.png') . '?' . time() }}"
        ...
        <div class="navbar-content">
            <ul class="dash-navbar">
                ...
                @canany(['manage cases', 'manage library'])
                    <li
                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'cases' || Request::segment(1) == 'library' ? 'active dash-trigger' : '' }}">
                        <a href="#!" class="dash-link ">
                            <span class="dash-micon"><i class="ti ti-file-text"></i>
                            </span><span class="dash-mtext">{{ __('Cases') }}</span>
                            <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
                        </a>
                        <ul
                            class="dash-submenu {{ Request::segment(1) == 'cases' || Request::segment(1) == 'library' ? 'show' : '' }}">

                            @can('manage case')
                                <li class="dash-item {{ in_array(Request::segment(1), ['cases', '']) ? ' active' : '' }}">
                                    <a class="dash-link" href="{{ route('cases.index') }}">{{ __('Cases') }}</a>
                                </li>
                            @endcan

                            @can('manage library')
                                <li class="dash-item {{ in_array(Request::segment(1), ['library', '']) ? ' active' : '' }}">
                                    <a class="dash-link" href="{{ route('library.index') }}">{{ __('Library') }}</a>
                                </li>
                            @endcan
                        </ul>
                    </li>
                ...
                @if (
                    (Auth::user()->super_admin_employee == 1 && array_search('manage crm', $premissionArr)) ||
                ...
                @if (
                    (Auth::user()->super_admin_employee == 1 && array_search('manage support ticket', $premissionArr)) ||
                        Auth::user()->type == 'company')
                    <li class="dash-item dash-hasmenu">
                        <a href="#!" class="dash-link">
                ...
                @if (Auth::user()->super_admin_employee == 1 && array_search('manage support ticket', $premissionArr))
                ...
                @if (Auth::user()->type == 'super admin' ||
                    ...
                    <li class="dash-item dash-hasmenu">
                        ...
                        <ul class="dash-submenu">
                            ...
                            @if (Auth::user()->super_admin_employee == 1 && array_search('manage crm', $premissionArr))
                                <li class="dash-item ">
                                    <a class="dash-link"
                ...
                @if (Auth::user()->type == 'super admin')
                    <li
                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'libraries' || Request::segment(1) == 'case-law-by-area-categories' || Request::segment(1) == 'case-law-by-areas' || Request::segment(1) == 'legislations' || Request::segment(1) == 'journals' || Request::segment(1) == 'researches' || Request::segment(1) == 'practice-tool-categories' || Request::segment(1) == 'practice-tools' || Request::segment(1) == 'recent-development-categories' || Request::segment(1) == 'recent-developments' || Request::segment(1) == 'super.admin.library' ? 'active dash-trigger' : '' }}">
                        <a href="#!" class="dash-link ">
                            <span class="dash-micon"><i class="ti ti-files"></i>
                            </span><span class="dash-mtext">{{ __('Library') }}</span>
                            <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
                        </a>
                        <ul
                            class="dash-submenu {{ Request::segment(1) == 'libraries' || Request::segment(1) == 'case-law-by-area-categories' || Request::segment(1) == 'case-law-by-areas' || Request::segment(1) == 'legislations' || Request::segment(1) == 'journals' || Request::segment(1) == 'researches' || Request::segment(1) == 'practice-tool-categories' || Request::segment(1) == 'practice-tools' || Request::segment(1) == 'recent-development-categories' || Request::segment(1) == 'recent-developments' || Request::segment(1) == 'super.admin.library' ? 'show' : '' }}">

                            <li class="dash-item {{ request()->is('libraries*') ? 'active' : '' }}">
                                <a class="dash-link"
                                    href="{{ route('libraries.index') }}">{{ __('Libraries') }}</a>
                            </li>
                            @canany(['manage case law by area category', 'manage case law by area'])
                                <li
                                    class="dash-item dash-hasmenu dash-trigger {{ Request::segment(1) == 'case-law-by-area-categories' || Request::segment(1) == 'case-law-by-areas' ? 'active' : '' }}">
                                    <a class="dash-link" href="#">{{ __('Case Law By Area') }}
                                    ...
                                    <ul
                                        class="dash-submenu {{ Request::segment(1) == 'case-law-by-area-categories' || Request::segment(1) == 'case-law-by-areas' ? 'show' : '' }}">
                                        @can('manage case law by area category')
                                            <li
                                                class="dash-item {{ request()->is('case-law-by-area-categories*') ? 'active' : '' }}">
                                                <a class="dash-link"
                                                    href="{{ route('case-law-by-area-categories.index') }}">
                                                    {{ __('Case Law By Area Categories') }}</a>
                                            </li>
                                        @endcan
                                        @can('manage case law by area')
                                            <li class="dash-item {{ request()->is('case-law-by-areas*') ? 'active' : '' }}">
                                                <a class="dash-link" href="{{ route('case-law-by-areas.index') }}">
                            ...
                            @can('manage legislation')
                                <li class="dash-item {{ request()->is('legislations*') ? 'active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('legislations.index') }}">{{ __('Legislations') }}</a>
                                </li>
                            @endcan
                            @can('manage journal')
                                <li class="dash-item {{ request()->is('journals*') ? 'active' : '' }}">
                                    <a class="dash-link" href="{{ route('journals.index') }}">{{ __('Journals') }}</a>
                                </li>
                            @endcan
                            @can('manage research')
                                <li class="dash-item {{ request()->is('researches*') ? 'active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('researches.index') }}">{{ __('Researches') }}</a>
                                </li>
                            @endcan
                            @canany(['manage practice tool category', 'manage practice tool'])
                                <li
                                    class="dash-item dash-hasmenu dash-trigger {{ Request::segment(1) == 'practice-tool-categories' || Request::segment(1) == 'practice-tools' ? 'active' : '' }}">
                                    <a class="dash-link" href="#">{{ __('Practice Tool') }}
                                        <span class="dash-arrow">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <ul
                                        class="dash-submenu {{ Request::segment(1) == 'practice-tool-categories' || Request::segment(1) == 'practice-tools' ? 'show' : '' }}">
                                        @can('manage practice tool category')
                                            <li
                                                class="dash-item {{ request()->is('practice-tool-categories*') ? 'active' : '' }}">
                                                <a class="dash-link" href="{{ route('practice-tool-categories.index') }}">
                                                    {{ __('Practice Tool Categories') }}</a>
                                            </li>
                                        @endcan
                                        @can('manage practice tool')
                                            <li class="dash-item {{ request()->is('practice-tool') ? 'active' : '' }}">
                                                <a class="dash-link" href="{{ route('practice-tools.index') }}">
                                                    {{ __('Practice Tools') }}</a>
                                            </li>
                                        @endcan
                                    </ul>
                            ...
                            @endcan
                            @canany(['manage recent development category', 'manage recent development'])
                                <li
                                    class="dash-item dash-hasmenu dash-trigger {{ Request::segment(1) == 'recent-development-categories' || Request::segment(1) == 'recent-developments' ? 'active' : '' }}">
                                    <a class="dash-link" href="#">{{ __('Recent Development') }}
                                        <span class="dash-arrow">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <ul
                                        class="dash-submenu {{ Request::segment(1) == 'recent-development-categories' || Request::segment(1) == 'recent-developments' ? 'show' : '' }}">
                                        @can('manage recent development category')
                                            <li
                                                class="dash-item {{ request()->is('recent-development-categories*') ? 'active' : '' }}">
                                                <a class="dash-link"
                                                    href="{{ route('recent-development-categories.index') }}">
                                                    {{ __('Recent Development Categories') }}</a>
                                            </li>
                                        @endcan
                                        @can('manage recent development')
                                            <li
                                                class="dash-item {{ request()->is('recent-developments*') ? 'active' : '' }}">
                                                <a class="dash-link" href="{{ route('recent-developments.index') }}">
                ...
                @if (Auth::check() &&
                        (Auth::user()->type == 'company' ||
                            Auth::user()->type == 'advocate' ||
                            Auth::user()->type == 'Clerk'))
                    @can('manage libraries')
                        <li
                            class="dash-item dash-hasmenu {{ in_array(Request::segment(1), ['libraries']) ? ' active' : '' }}">
                            <a href="{{ route('libraries.index') }}" class="dash-link">
                                <span class="dash-micon"><i class="ti ti-clipboard-list"></i></span>
                                <span class="dash-mtext">{{ __('Libraries') }}</span>
                            </a>
                        </li>
                    @endcan
                @endif
                ...
                @if (Auth::user()->type == 'super admin' || Auth::user()->type == 'company')
                    @can('manage library settings')
                        <li class="dash-item {{ Request::segment(1) == 'library-settings' ? 'active' : '' }}">
                            <a class="dash-link" href="{{ route('library.settings') }}">
                                <span class="dash-micon"><i class="ti ti-credit-card"></i></span><span
                                    class="dash-mtext">{{ __('Libraries Settings') }}</span>
                            </a>
                        </li>
                    @endcan
                @endif
