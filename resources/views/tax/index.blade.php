...
@section('action-button')
    @can('create tax')
        <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
            <a href="javascript:void(0)" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="md" data-title="Add Tax"
                            ...
                            <tbody>
                                ...
                                @foreach ($taxes as $key => $tax)
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="javascript:void(0)" class="btn btn-sm " data-url="{{ route('taxs.edit', $tax->id) }}" data-size="md" data-ajax-popup="true"
