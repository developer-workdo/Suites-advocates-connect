                                    ...
                                    <div class="col-xxl-3 col-lg-5 col-md-6 col-sm-6 plan_card mb-0 border-bottom border-end">
                                        <div class="card shadow-none  price-card price-1 rounded-0">
                                            <div class="card-body ">
                                                ...
                                                <div class="p-0">
                                                    <a href="javascript:void(0)" class="btn btn-sm btn-light-primary" data-url="{{ route('plan.upgrade',$user->id) }}"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="action-btn bg-light-secondary ms-2">
                                                                <a href="javascript:void(0)" data-url="{{route('company.reset',\Crypt::encrypt($employee->id))}}"
