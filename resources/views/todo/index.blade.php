...
@section('action-button')
    @can('create todo')
        <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
            <a href="javascript:void(0)" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="md" data-title="Add To-Do"
                    ...
                    <div class="tab-pane fade show active" id="pills-user-1" role="tabpanel"
                        ...
                        <table class="table dataTable data-table ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="javascript:void(0)" class="btn btn-sm" data-url="{{ route('to-do.show', $todo->id) }}" data-size="md" data-ajax-popup="true"
                                    ...
                                    <td>
                                        ...
                                        @can('edit todo')
                                            ...
                                            <div class="action-btn  disabled-form-switch">
                                                <a href="javascript:void(0)" data-size="md" data-url="{{ route('to-do.status', $todo->id) }}" data-ajax-popup="true"
