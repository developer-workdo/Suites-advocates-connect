...
<div class="text-sm-end d-flex all-button-box justify-content-sm-end">
    <a href="javascript:void(0)" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="md" data-title="Add Cause"
                ...
                <div class="table-responsive">
                    <table class="table dataTable data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="javascript:void(0)" class="btn btn-sm" data-url="{{ route('cause.show', $caus->id) }}" data-size="md" data-ajax-popup="true"
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.status == 1) {
                            ...
                            $('#bench_div').empty();
                            $('#bench_div').append('<label for="bench" class="form-label">Circuit/Division</label> <select class="form-control" name="bench" id="bench"> </select>');
