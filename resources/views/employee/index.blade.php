...
<div class="row align-items-center mb-3">
    <div class="col-md-12 d-flex align-items-center  justify-content-end">
        ...
        <div class="text-end d-flex all-button-box justify-content-md-end justify-content-center">
            <a href="javascript:void(0)" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="lg"
                                ...
                                <div class="btn-group card-option">
                                    ...
                                    @if (Auth::user()->type == 'super admin' )
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="javascript:void(0)" class="dropdown-item" data-bs-original-title="{{__('Edit Employee')}}" data-ajax-popup="true" data-size="lg" data-title="Edit Employee" data-url="{{route('employee.edit', $employee->id)}}" data-toggle="tooltip">
                                            ...
                                            @canany(['delete member','delete user'])
                                                ...
                                                <a href="javascript:void(0)" class="dropdown-item bs-pass-para-user-delete" data-id="{{ $employee['id'] }}" data-confirm="{{ __('Are You Sure?') }}"
            ...
            <div class="col-md-6 col-xxl-3 col-lg-4 col-sm-6 border-end border-bottom">
                <div class="card  shadow-none bg-transparent border h-100 text-center rounded-0">
                    <div class="card-body border-0 pb-0">
                        <a href="javascript:void(0)" class="btn-addnew-project border-0" data-ajax-popup="true" data-size="lg" data-title="Create New Employee"
