...
<div class="row align-items-center mb-3">
    <div class="col-md-12 d-flex justify-content-sm-end">
        <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
            <a href="javascript:void(0)" class="btn btn-sm btn-dark mx-1" data-ajax-popup="true" data-size="md"
        ...
        <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
            <a href="javascript:void(0)" class="btn btn-sm btn-info mx-1" data-ajax-popup="true" data-size="md"
                        ...
                        <div class="card-header">
                            <div class="float-end">
                                <p class="text-muted d-none d-sm-flex align-items-center mb-0">
                                    <a href="javascript:void(0)" class="btn btn-sm btn-primary btn-icon m-1" data-ajax-popup="true"
                            ...
                            <div class="float-end">
                                @if (\Auth::user()->super_admin_employee == 1)
                                    <p class="text-muted d-none d-sm-flex align-items-center mb-0">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-sm btn-primary btn-icon m-1"
                                            data-ajax-popup="true" data-size="md"
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                @foreach ($deal->discussions as $discussion)
                                    <a href="javascript:void(0)" class="list-group-item bg-transparent border rounded-0 mb-3">
                                        <div class="d-flex align-items-center">
                                            <div>
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                @foreach($emails as $email)
                                    <a href="javascript:void(0)" class="list-group-item bg-transparent border-bottom rounded-0 mb-3">
                                        <div class="d-flex align-items-center">
                                            <div>
