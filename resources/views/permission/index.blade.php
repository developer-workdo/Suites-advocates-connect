...
@section('action-button')
    ...
    @can('create permission')
        ...
        <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
            <a href="javascript:void(0)" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="md" data-title="Add Permission"
                                    ...
                                    <td class="action">
                                        ...
                                        @can('edit permission')
                                            <div class="action-btn bg-light-secondary ms-2">
                                                <a href="javascript:void(0)" data-url="{{ route('permissions.edit',$permission->id) }}"
