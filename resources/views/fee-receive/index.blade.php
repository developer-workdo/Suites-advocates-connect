...
@section('action-button')
    @can('create feereceived')
        ...
        <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
            ...
            <a href="javascript:void(0)" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="md" data-title="Add Fee Received"
                ...
                <div class="table-responsive">
                    <table class="table dataTable data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="javascript:void(0)" class="btn btn-sm" data-url="{{ route('fee-receive.show', $expense->id) }}" data-size="md"
