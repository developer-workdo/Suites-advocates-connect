...
<div class="text-sm-end d-flex all-button-box justify-content-sm-end">
    <a href="{{ route('casediary.index') }}" class="mx-1 btn btn-md btn-primary" data-bs-toggle="tooltip"
...
@section('content')
    <div class="p-0 row g-0">
        ...
        <div class="col-lg-4 border-bottom">
            ...
            <div class="shadow-none card rounded-0 border-bottom">
                <div class="card-body">
                    <div class="row justify-content-around">
                        <div class="my-2 col-md-4 col-6">
                            <div class="d-flex align-items-start">
                                <div class="theme-avtar bg-info">
                                    <i class="ti ti-calendar-event"></i>
                                </div>
                                <div class="ms-2">
                                    <p class="mb-0 text-sm text-muted">{{ __('To-Dos') }}</p>
                        ...
                        <div class="my-2 col-md-4 col-6">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="ms-2">
                                    <p class="mb-0 text-sm text-muted">{{ __('Case Hearing') }}</p>
            ...
            <div class="shadow-none card rounded-0">
                <div class="px-0 card-body">
                    <h4 class="px-3 mb-4">{{ __('Tasks') }}</h4>
                    <ul class="event-cards list-group list-group-flush w-100">
                        ...
                        @foreach ($events as $calenderData)
                            ...
                            @endphp
                            @if ($month == date('m'))
                                <li class="mb-3 bg-transparent shadow-none list-group-item card border-top border-bottom rounded-0">
