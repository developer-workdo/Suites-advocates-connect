...
@if(\Auth::user()->super_admin_employee == 1)
    <div class="row align-items-center mb-3">
        <div class="col-md-12 d-flex justify-content-sm-end">
            ...
            @else
                <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
                    <a href="javascript:void(0)" class="btn btn-sm btn-warning mx-1" data-ajax-popup="true" data-size="md"
                        ...
                        <div class="card-header">
                            <div class="row g-0">
                                ...
                                <div class="col-md-2">
                                    <div class="float-end">
                                        @if (\Auth::user()->super_admin_employee == 1)
                                        <a href="javascript:void(0)" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true"
