...
@section('action-button')
    <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
        <a href="{{ route('bills.show', $bill->id) }}" class="mx-1 btn btn-sm btn-primary" data-toggle="tooltip"
...
@section('content')
    ...
    <div class="p-0 row g-0">
        <div class="col-12">
            <div class="p-3">
                <div>
                    <div class="mb-3 bg-transparent border shadow-none card rounded-0">
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                        ...
                                        <div class="form-group " id="custom_advocate_div">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <label class="mb-2 col-3">{{ __('Name:') }}</label>
                                                    <span>{{ Utility::getcompanyValByName('name') }}</span><br>
                                                    <label class="mb-2 col-3">{{ __('Phone Number:') }}</label>
                                                    <span>{{ Utility::getcompanydetailValByName('phone_number') }}</span><br>
                                                    <label class="mb-2 col-3">{{ __('Address:') }} </label>
                                                    <span>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                        <div class="items-end row flex-column align-items-end">
                                            <div class="col-md-12">
                                                <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="border shadow-none card repeater" data-value='{!! $bill->items !!}'>
                                        <div class="py-2 item-section">
                                            <div class="row ">
                                                <div class="items-end col-md-12 d-flex justify-content-end">
