    ...
    <div class="col-sm-12">
        <div class="row g-0">
            <div class="col-xl-3 border-end border-bottom">
                <div class="card shadow-none bg-transparent sticky-top">
                    ...
                    <div class="list-group list-group-flush rounded-0" id="useradd-sidenav">
                        ...
                        @endif
                        @if (isset($admin_payment_setting['is_pesapal_enabled']) && $admin_payment_setting['is_pesapal_enabled'] == 'on')
                            <a class="list-group-item list-group-item-action border-0" data-toggle="tab"
                                href="#bank-payment" role="tab" aria-controls="manually"
                                aria-selected="true">{{ __('PesaPal') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                        @endif
            ...
            <div class="col-xl-9">
                                    ...
                                    <form>
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-6 text-right">
                                                <b>{{ __('Plan Price') }}</b> :
                                                {{ $admin_payment_setting['currency_symbol'] ? $admin_payment_setting['currency_symbol'] : '$' }}{{ $plan->price }}<b
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="float-end">
                                                        ...
                                                        <button class="btn btn-primary d-flex align-items-center"
                                                            ...
                                                            (<span
                                                                class="bank-final-price">{{ $admin_payment_setting['currency_symbol'] ? $admin_payment_setting['currency_symbol'] : '$' }}{{ $plan->price }}</span>)
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                ...
                @if (isset($admin_payment_setting['is_pesapal_enabled']) && $admin_payment_setting['is_pesapal_enabled'] == 'on')
                    <div id="pesapal-payment" class="card  shadow-none rounded-0 border-bottom">
                        <div class="card-header">
                            <h5>{{ __('Pay Using PesaPal') }}</h5>
                            <small class="text-muted">{{ __('Details about your plan PesaPal payment') }}</small>
                        </div>
                        <div class="card-body">
                            <form role="form" action="{{ route('plan.pay.with.pesapal') }}" method="post"
                                class="require-validation" id="payment-form">
                                @csrf
                                <div class=" rounded pesapal-payment-div">
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                <label for="pesapal_coupon"
                                                    class="form-label text-dark">{{ __('Coupon') }}</label>
                                                <input type="text" id="pesapal_coupon" name="coupon"
                                                    class="form-control coupon" data-from="pesapal"
                                                    placeholder="{{ __('Enter Coupon Code') }}">
                                            </div>
                                        </div>
                                        <div class="col-md-2 coupon-apply-btn mt-4">
                                            <div class="form-group apply-pesapal-btn-coupon">
                                                <a href="javascript:void(0)"
                                                    class="btn btn-primary align-items-center apply-coupon"
                                                    data-from="pesapal">{{ __('Apply') }}</a>
                                            </div>
                                        </div>
                                        <div class="col-12 text-right pesapal-coupon-tr" style="display: none">
                                            <b>{{ __('Coupon Discount') }}</b> : <b class="pesapal-coupon-price"></b>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-sm-12">
                                                <div class="float-end">
                                                    ...
                                                    <button class="btn btn-primary d-flex align-items-center"
                                                        ...
                                                        <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }}
                                                        (<span
                                                            class="pesapal-final-price">{{ $admin_payment_setting['currency_symbol'] }}{{ $plan->price }}</span>)
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="float-end">
                                                    ...
                                                    <button class="btn btn-primary d-flex align-items-center"
                                                        ...
                                                        {{ __('Pay Now') }} (<span
                                                            class="toyyibpay-final-price">{{ $admin_payment_setting['currency_symbol'] ? $admin_payment_setting['currency_symbol'] : '$' }}{{ $plan->price }}</span>)</button>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="float-end">
                                                        ...
                                                        <button class="btn btn-primary d-flex align-items-center"
                                                            ...
                                                            <i class="mdi mdi-cash-multiple mr-1"></i>
                                                            {{ __('Pay Now') }} (<span
                                                                class="payfast-final-price">{{ $admin_payment_setting['currency_symbol'] ? $admin_payment_setting['currency_symbol'] : '$' }}{{ $plan->price }}</span>)</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="float-end">
                                                    ...
                                                    <button class="btn btn-primary d-flex align-items-center"
                                                        ...
                                                        {{ __('Pay Now') }}
                                                        (<span
                                                            class="iyzipay-final-price">{{ $admin_payment_setting['currency_symbol'] ? $admin_payment_setting['currency_symbol'] : '$' }}{{ $plan->price }}</span>)
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                ...
                @if (isset($admin_payment_setting['is_paytr_enabled']) && $admin_payment_setting['is_paytr_enabled'] == 'on')
                    <div id="useradd-22" class="card  shadow-none rounded-0 border-bottom ">
                        <form class="w3-container w3-display-middle w3-card-4" method="POST" id="paytr-payment-form"
                            action="{{ route('plan.pay.with.paytr') }}">
                            @csrf <div class="card-header">
                                <h5>{{ __('Pay TR') }}</h5>
                            </div>
                            <div class="card-body">
                ...
                @if (isset($admin_payment_setting['is_yookassa_enabled']) && $admin_payment_setting['is_yookassa_enabled'] == 'on')
                    <div id="useradd-23" class="card  shadow-none rounded-0 border-bottom ">
                        <form class="w3-container w3-display-middle w3-card-4" method="get" id="paytr-payment-form"
                            action="{{ route('plan.pay.with.yookassa') }}">
                            @csrf <div class="card-header">
                                <h5>{{ __('Yookassa') }}</h5>
                            </div>
                            <div class="card-body">
                ...
                @if (isset($admin_payment_setting['is_payhere_enabled']) && $admin_payment_setting['is_payhere_enabled'] == 'on')
                    <div id="useradd-26" class="card  shadow-none rounded-0 border-bottom ">
                        <form class="w3-container w3-display-middle w3-card-4" method="post"
                            id="midtrans-payment-form" action="{{ route('plan.payhere.payment') }}">
                            @csrf <div class="card-header">
                                <h5>{{ __('PayHere') }}</h5>
                            </div>
                            <div class="card-body">
