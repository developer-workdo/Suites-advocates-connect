        ...
        <div class="col-sm-12">
            <div class="row g-0">
                <div class="col-xl-3 border-end border-bottom">
                    <div class="bg-transparent shadow-none card sticky-top" style="top:70px">
                        <div class="list-group list-group-flush rounded-0" id="useradd-sidenav">
                            ...
                            <a href="#useradd-10"
                                class="list-group-item list-group-item-action">{{ __('library Settings') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                            <a href="#location-list" class="border-0 list-group-item list-group-item-action"
                ...
                <div class="col-xl-9" data-bs-spy="scroll" data-bs-target="#useradd-sidenav" data-bs-offset="0"
                        ...
                        <div class="pb-0 card-body">
                            <div class="row">
                                <div class="col-lg-4 col-sm-6 col-md-6 dashboard-card">
                                    <div class="border shadow-none card rounded-0">
                                        <div class="card-header">
                                            <h5>{{ __('Logo dark') }}</h5>
                                        </div>
                                        <div class="card-body ">
                                                ...
                                                <div
                                                    ...
                                                    <div class="mt-5 choose-files">
                                                        <label for="company_logo">
                                                            <div class="m-auto bg-primary company_logo_update"> <i
                                                ...
                                                <div
                                                    ...
                                                    <div class="mt-5 choose-files">
                                                        <label for="company_logo_light">
                                                            <div class="m-auto bg-primary dark_logo_update"> <i
                                                                    class="px-1 ti ti-upload"></i>{{ __('Choose file here') }}
                                                            </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="mt-4 choose-files">
                                                        <label for="company_favicon">
                                                            <div class="m-auto bg-primary company_favicon_update"> <i
                                                                    class="px-1 ti ti-upload"></i>{{ __('Choose file here') }}
                                                            </div>
                                ...
                                <div class="pb-0 card-footer text-end pe-0">
                                    <div class="form-group">
                    ...
                    <!--Email Setting-->
                    <div class="shadow-none card rounded-0 border-bottom" id="useradd-2">
                        <div class="card-header">
                    ...
                    <div class="shadow-none card rounded-0 border-bottom" id="useradd-3">
                        <div class="card-header">
                                            ...
                                            <div class="row">
                                                <div class="accordion accordion-flush setting-accordion"
                                                    ...
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="headingPesapal">
                                                            <button class="accordion-button collapsed" type="button"
                                                                data-bs-toggle="collapse" data-bs-target="#collapsePesapal"
                                                                aria-expanded="false" aria-controls="collapsePesapal">
                                                                <span class="d-flex align-items-center">
                                                                    <i class=""></i> {{ __('PesaPal') }}
                                                                </span>
                                                                <div class="d-flex align-items-center">
                                                                    <span class="me-2">{{ __('Enable') }}</span>
                                                                    <div class="form-check form-switch custom-switch-v1">
                                                                        <input type="hidden" name="is_pesapal_enabled"
                                                                            value="off">
                                                                        <input type="checkbox"
                                                                            class="form-check-input input-primary"
                                                                            name="is_pesapal_enabled"
                                                                            id="is_pesapal_enabled"
                                                                            {{ isset($payment['is_pesapal_enabled']) && $payment['is_pesapal_enabled'] == 'on' ? 'checked="checked"' : '' }}>
                                                        ...
                                                        <div id="collapsePesapal" class="accordion-collapse collapse"
                                                            aria-labelledby="headingPesapal"
                                                            data-bs-parent="#accordionExample">
                                                            <div class="accordion-body">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="pesapal_key"
                                                                                class="col-form-label">{{ __('PesaPal Key') }}</label>
                                                                            <input class="form-control"
                                                                                placeholder="{{ __('PesaPal Key') }}"
                                                                                name="pesapal_key" type="text"
                                                                                value="{{ !isset($payment['pesapal_key']) || is_null($payment['pesapal_key']) ? '' : $payment['pesapal_key'] }}"
                                                                                id="pesapal_key">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="pesapal_secret"
                                                                                class="col-form-label">{{ __('PesaPal Secret') }}</label>
                                                                            <input class="form-control "
                                                                                placeholder="{{ __('PesaPal Secret') }}"
                                                                                name="pesapal_secret" type="text"
                                                                                value="{{ !isset($payment['pesapal_secret']) || is_null($payment['pesapal_secret']) ? '' : $payment['pesapal_secret'] }}"
                                                                                id="pesapal_secret">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="pesapal_api_url" class="col-form-label">{{ __('PesaPal API URL') }}</label>
                                                                            <input class="form-control" placeholder="{{ __('PesaPal API URL') }}" name="pesapal_api_url" type="url"
                                                                                value="{{ !isset($payment['pesapal_api_url']) || is_null($payment['pesapal_api_url']) ? '' : $payment['pesapal_api_url'] }}"
                                                                                id="pesapal_api_url">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="collapse15" class="accordion-collapse collapse"
                                                            ...
                                                            <div class="accordion-body">
                                                                <div class="row">
                                                                    <div
                                                                        class="pb-4 col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                                        <div class="pt-2 row">
                                                                            <label class="pb-2"
                                                    ...
                                                    <div class="accordion-item ">
                                                        ...
                                                        <div id="collapse14" class="accordion-collapse collapse"
                                                            ...
                                                            <div class="accordion-body">
                                                                <div class="pb-4 col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                                    <label class="col-form-label"
                                                    ...
                                                    <div class="shadow-none accordion-item card ">
                    ...
                    {{-- SEO Settings --}}
                    <div class="shadow-none card rounded-0 border-bottom" id="useradd-4">
                    ...
                    {{-- recaptcha Settings --}}
                    <div class="shadow-none card rounded-0 border-bottom" id="useradd-5">
                        <div class="col-md-12">
                    ...
                    {{-- Cache Settings --}}
                    <div class="shadow-none card rounded-0 border-bottom" id="useradd-6">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-12">
                    ...
                    {{-- storage Setting --}}
                    <div class="shadow-none card rounded-0 border-bottom" id="useradd-7">
                    ...
                    {{-- Cookie Consent --}}
                    <div class="shadow-none card rounded-0 border-bottom" id="useradd-8">
                        {{ Form::model($settings, ['route' => 'cookie.setting', 'method' => 'post']) }}
                        <div
                            class="gap-2 card-header flex-column flex-lg-row d-flex align-items-lg-center justify-content-between align-items-center flex--column flex-sm-row">
                        ...
                        <div
                            class="gap-2 card-footer d-flex align-items-center flex--column flex-sm-row justify-content-between">
                            <div>
                    ...
                    <!--Pusher Settings-->
                    <div class="shadow-none card rounded-0 border-bottom" id="useradd-9">
                        <div class="card-header">
                    ...
                    <div id="location-list" class="shadow-none card rounded-0 border-bottom">
                                    ...
                                    <div class="col-6 text-end row">
                                        ...
                                        <form method="GET" action="{{ route('admin.settings') }}"
                                            ...
                                            <div class=" d-flex align-items-center justify-content-end">
                                                ...
                                                <div class="mr-2 col-xl-2 col-lg-3 col-md-6 col-sm-12 col-12">
