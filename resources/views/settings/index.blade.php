        ...
        <div class="col-sm-12">
            <div class="row g-0">
                <div class="col-xl-3 border-end border-bottom ">
                    <div class="bg-transparent shadow-none card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush rounded-0" id="useradd-sidenav">
                            ...
                            @if ($authUser->type == 'company')
                                <a href="#useradd-8"
                                    class="border-0 list-group-item list-group-item-action">{{ __('Google Calendar Settings') }}
                                    <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                                </a>
                            @endif
                ...
                <div class="col-xl-9" data-bs-spy="scroll" data-bs-target="#useradd-sidenav" data-bs-offset="0"
                    ...
                    <!--Business Setting-->
                    <div class="border shadow-none card rounded-0" id="useradd-1">
                    ...
                    <!--Payment Setting-->
                    <div id="useradd-7" class="border shadow-none card rounded-0">
                        <div class="card-header">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="form-check form-switch custom-switch-v1">
                                                            ...
                                                            <input type="checkbox"
                                                                ...
                                                                {{ isset($company_payment_setting['is_pesapal_enabled']) && $company_payment_setting['is_pesapal_enabled'] == 'on' ? 'checked="checked"' : '' }}>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                    ...
                                                                    value="{{ !isset($company_payment_setting['pesapal_key']) || is_null($company_payment_setting['pesapal_key']) ? '' : $company_payment_setting['pesapal_key'] }}"
                                                                    id="pesapal_key">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control "
                                                                    ...
                                                                    value="{{ !isset($company_payment_setting['pesapal_secret']) || is_null($company_payment_setting['pesapal_secret']) ? '' : $company_payment_setting['pesapal_secret'] }}"
                                                                    id="pesapal_secret">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" placeholder="{{ __('PesaPal API URL') }}" name="pesapal_api_url" type="url"
                                                                    value="{{ !isset($company_payment_setting['pesapal_api_url']) || is_null($company_payment_setting['pesapal_api_url']) ? '' : $company_payment_setting['pesapal_api_url'] }}"
                                                                    id="pesapal_api_url">
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <div class="shadow-none card rounded-0 border-bottom" id="useradd-9">
                        ...
                        @csrf
                        {{ Form::hidden('mail_driver', null, ['class' => 'form-control', 'id' => 'mail_driver', 'placeholder' => __('Enter Mail Driver')]) }}
                        {{ Form::hidden('mail_host', null, [
                            'class' => 'form-control ',
                            'id' => 'mail_host',
                            'placeholder' => __('Enter Mail Host'),
                        ]) }}
                        {{ Form::hidden('mail_port', null, [
                            'class' => 'form-control',
                            'id' => 'mail_port',
                            'placeholder' => __('Enter Mail Port'),
                        ]) }}
                        {{ Form::hidden('mail_username', null, [
                            'class' => 'form-control',
                            'id' => 'mail_username',
                            'placeholder' => __('Enter Mail Username'),
                        ]) }}
                        {{ Form::hidden('mail_password', null, [
                            'class' => 'form-control',
                            'id' => 'mail_password',
                            'placeholder' => __('Enter Mail Password'),
                        ]) }}
                        {{ Form::hidden('mail_encryption', null, [
                            'class' => 'form-control',
                            'id' => 'mail_encryption',
                            'placeholder' => __('Enter Mail Encryption'),
                        ]) }}
                        {{ Form::hidden('mail_from_address', null, ['class' => 'form-control', 'id' => 'mail_from_address', 'placeholder' => __('Enter Mail From Address')]) }}
                        {{ Form::hidden('mail_from_name', null, [
                            'class' => 'form-control',
                            'id' => 'mail_from_name',
