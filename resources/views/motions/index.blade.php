...
@section('action-button')
    @php
        $permission = auth()->user()->type == 'super admin' ? 'create motions' : 'create group';
    @endphp
    @can($permission)
        <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
            <a href="javascript:void(0)" class="mx-1 btn btn-sm btn-primary" data-ajax-popup="true" data-size="md" data-title="Add Motions Type"
