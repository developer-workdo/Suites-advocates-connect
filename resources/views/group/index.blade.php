...
@section('action-button')
    @can('create group')
        <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
            <a href="javascript:void(0)" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="md" data-title="Add Group"
                        ...
                        <table class="table dataTable data-table">
                            ...
                            <tbody>
                                ...
                                @foreach ($groups as $key => $group)
                                    ...
                                    <tr>
                                        <td>
                                            <a href="javascript:void(0)" class="btn btn-sm " data-url="{{ route('groups.show', $group->id) }}" data-size="md" data-ajax-popup="true"
