                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row p-0">
                            <dl class="row col-md-6 p-5 py-2">
                                ...
                                <dd class="col-md-7"><span
                                        class="text-md">{{ !empty($case->case_number) ? $case->case_number : '' }}</span>
                                </dd>
                                    ...
                                    <div class=" row">
                                        @foreach ($docs as $key => $document)
                                            <div class=" row col-6 p-5 py-2">
                                                ...
                                                <dt class="col-md-4"><span
                                                        class="h6 text-md mb-0">{{ __('View:') }}</span></dt>
                                                <dd class="col-md-4"><span class="text-md"><a
                                                            href="{{ $documentsfile . $document->file }}"target="_blank">{{ __('Click here') }}</a></span>
                                                </dd>
                                                ...
                                                <dt class="col-md-4"><span
                                                        class="h6 text-md mb-0">{{ __('Download:') }}</span></dt>
                                                <dd class="col-md-8"><span class="text-md"><a
                                                            href="{{ $documentsfile . $document->file }}" target="_blank"
                                                            download>{{ __('Click here') }}</a></span></dd>
                                    ...
                                    @if (isset($library))
                                        <div class=" row">
                                            ...
                                            <div class=" row col-6 p-5 py-2">
                                                ...
                                                <dd class="col-md-8">
                                                    <span class="text-md">
                                                        <a href="{{ \App\Models\Utility::get_file($library->case_law) }}"
                                                            target="_blank" download="">{{ __('Click here') }}
                                                        </a>
                                                    </span>
                                                </dd>
                                    ...
                                    <div class="row px-3">
                                        ...
                                        @if (Auth::user()->type != 'client')
                                            <div class="col-xl-10 text-end">
                                                <a href="javascript:void(0)" class="btn btn-sm btn-primary" data-ajax-popup="true"
                                                ...
                                                <a href="javascript:void(0)" class="btn btn-sm btn-primary" data-ajax-popup="true"
                                                    data-size="md" data-title="{{ __('New Hearing') }}"
                                                    data-url="{{ route('hearings.create', $case->id) }}"
                                                    data-toggle="tooltip" title="{{ __('Add Hearing') }}"
                                                    data-bs-original-title="{{ __('Create New Hearing') }}"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if (!empty($hearing->order_seet))
                                                                <a href="{{ $docfile . $hearing->order_seet }}"
