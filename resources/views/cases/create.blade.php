                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group  d-none" id="bench_div">
                                {!! Form::label('court', __('Circuit/Division'), ['class' => 'form-label']) !!}
                ...
                success: function(data) {
                    ...
                    if (data.status == 1) {
                        ...
                        $('#highcourt_div').removeClass('d-none').append(
                            '<a href="javascript:void(0)" data-url={{ route('bench.create') }} data-title="Add Circuit/Division" data-ajax-popup="true" data-size="md" title={{ __('Create New Circuit/Division') }}><span class="text-danger" id="danger-span">Please add Circuit/Division to current high court</span></a>'
                        )
                    }
