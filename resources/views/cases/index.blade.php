...
@section('action-button')
    @can('create case')
        <div class="text-sm-end d-flex all-button-box justify-content-sm-end mx-1">
            <a href="javascript:void(0)" data-size="md" data-bs-toggle="tooltip" title="{{ __('Import') }}"
                data-url="{{ route('case.file.import') }}" data-ajax-popup="true" data-title="{{ __('Import customer CSV file') }}"
