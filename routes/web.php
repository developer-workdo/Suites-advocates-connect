...
use App\Http\Controllers\CaseLawByAreaCategoryController;
use App\Http\Controllers\CaseLawByAreaController;
...
use App\Http\Controllers\PracticeToolCategoryController;
use App\Http\Controllers\PracticeToolController;
use App\Http\Controllers\PriorityController;
use App\Http\Controllers\RecentDevelopmentCategoryController;
use App\Http\Controllers\RecentDevelopmentController;
...
Route::group(['middleware' => ['auth', 'XSS', 'verified']], function () {
    ...
    // Libraries
    Route::post('libraries-filter', [LibrariesController::class, 'filterData'])->name('libraries.filter');
    Route::get('case-law-by-area-search-data', [LibrariesController::class, 'caseLawByAreaSearchData'])->name('libraries.case.law.by.area.search.data');
    Route::get('journal-search-data', [LibrariesController::class, 'journalSearchData'])->name('libraries.journal.search.data');
    Route::get('my-libraries', [LibrariesController::class, 'index'])->name('my.libraries.index');
    Route::get('libraries', [LibrariesController::class, 'index'])->name('libraries.index');
    Route::get('libraries', [LibrariesController::class, 'index'])->name('libraries.index');
    Route::get('library/{id}/{slug}', [LibrariesController::class, 'show'])->name('library.show');
    Route::resource('case-law-by-area-categories', CaseLawByAreaCategoryController::class);
    Route::resource('case-law-by-areas', CaseLawByAreaController::class);
    Route::get('case-law-by-area/create/{case_id}', [CaseLawByAreaController::class, 'companyCaseLawByAreaCreate'])->name('company.case-law-by-area.create');
    Route::resource('practice-tool-categories', PracticeToolCategoryController::class);
    Route::resource('practice-tools', PracticeToolController::class);
    Route::get('practice-tool/create/{practice_tool_id}', [PracticeToolController::class, 'companyPracticeToolCreate'])->name('company.practice-tool.create');
    Route::resource('recent-development-categories', RecentDevelopmentCategoryController::class);
    Route::resource('recent-developments', RecentDevelopmentController::class);
    Route::get('recent-development/create/{recent_development_id}', [RecentDevelopmentController::class, 'companyRecentDevelopmentCreate'])->name('company.recent-development.create');
    Route::resource('legislations', LegislationController::class);
    Route::resource('journals', JournalController::class);
    Route::resource('researches', ResearchController::class);
    Route::get('library-settings/{type?}', [LibrarySettingcontroller::class, 'loadLibrarySetting'])->name('library.settings');
    Route::post('library-setting-store', [LibrarySettingcontroller::class, 'saveLibrarySettings'])->name('library.setting.store');
    ...
    // PesaPal
    Route::post('/pesapal/submit-order', [PesapalController::class, 'planPayWithPesaPal'])->name('plan.pay.with.pesapal');
    Route::get('/pesapal/payment-callback', [PesapalController::class, 'paymentCallback'])->name('pesapal.payment.callback');
    Route::get('/pesapal/refund/{id}', [PesapalController::class, 'showPesaPalRefundForm'])->name('pesapal.refund');
    Route::post('/pesapal/refund-request/{id}', [PesapalController::class, 'pesapalRefundRequest'])->name('pesapal.refund.request');
    ...
    Route::post('ckeditor/upload', [SettingController::class, 'upload'])->name('ckeditor.upload')->middleware(['auth']);
